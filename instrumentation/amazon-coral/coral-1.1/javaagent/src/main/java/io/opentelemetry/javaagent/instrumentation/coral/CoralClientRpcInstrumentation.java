...
import static io.opentelemetry.javaagent.instrumentation.coral.CoralClientSingletons.instrumenter;
...
public class CoralClientRpcInstrumentation implements TypeInstrumentation {
  ...
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("com.amazon.coral.client.HttpRpcClientHandler");
  }

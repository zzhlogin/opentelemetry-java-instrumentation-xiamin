    ...
    assertTraces(9) {
      ...
      trace(2, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes PutRolePolicy!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(3, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes CreateFunction!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(4, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes CreateQueue!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(5, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes GetQueueAttributes!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(6, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes GetFunction!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(7, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes CreateEventSourceMapping!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
      ...
      trace(8, 1) {
        span(0) {
          ...
          kind CLIENT
          hasNoParent()
          println("   attributes GetEventSourceMapping!!!!!!!!!!")
          span.attributes.each { attribute ->
            println("      ${attribute}")
          }
          attributes {
